...
export default function OfferReviewForm({ id }: { id: string }): JSX.Element {
  ...
  const isSubmitDisabled = (formData.review.length < MIN_COMMENT_CHARACTERS) || formData.review.length > MAX_COMMENT_CHARACTERS || (formData.rating === null) || isCommentDataSending;
  ...
  return (
    <form className="reviews__form form" action="#" method="post" onSubmit={ submitHandle }>
      ...
      <div className="reviews__rating-form form__rating">
        <input className="form__rating-input visually-hidden" name="rating" value="5" id="5-stars" type="radio" disabled={ isCommentDataSending } onChange={ fieldChangeHandle } checked={ formData.rating === '5' }/>
        ...
        <input className="form__rating-input visually-hidden" name="rating" value="4" id="4-stars" type="radio" disabled={ isCommentDataSending } onChange={ fieldChangeHandle } checked={ formData.rating === '4' }/>
        ...
        <input className="form__rating-input visually-hidden" name="rating" value="3" id="3-stars" type="radio" disabled={ isCommentDataSending } onChange={ fieldChangeHandle } checked={ formData.rating === '3' }/>
        ...
        <input className="form__rating-input visually-hidden" name="rating" value="2" id="2-stars" type="radio" disabled={ isCommentDataSending } onChange={ fieldChangeHandle } checked={ formData.rating === '2' }/>
